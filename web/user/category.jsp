        ...
        <div class="layout">
            ...
            <div class="main">
                ...
                <div class="sort-options">
                    <a href="<%= request.getContextPath() %>/user/category.jsp?category=<%= category %>&sort=asc<%= keyword != null ? "&keyword=" + keyword : "" %>">Sort by Price: Low to High</a>
                    <a href="<%= request.getContextPath() %>/user/category.jsp?category=<%= category %>&sort=desc<%= keyword != null ? "&keyword=" + keyword : "" %>">Sort by Price: High to Low</a>
                </div>
