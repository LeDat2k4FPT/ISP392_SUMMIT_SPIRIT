...
<html>
    ...
    <body>
        <div class="container mt-4">
            ...
            <form method="post" action="${pageContext.request.contextPath}/ManageVoucherController">
            ...
            <table class="table table-bordered mt-3">
                ...
                <form method="post" action="${pageContext.request.contextPath}/ManageVoucherController" style="display:inline;">
                    <input type="hidden" name="voucherID" value="<%=v.getVoucherID()%>">
