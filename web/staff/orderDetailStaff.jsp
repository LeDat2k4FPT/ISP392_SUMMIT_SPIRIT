            ...
            <div class="order-info">
                ...
                <div>
                    ...
                    <%
                        ...
                        else if ("Packed".equalsIgnoreCase(status)) badgeClass += " status-packed";
                    %>
                    <span class="<%= badgeClass %>"><%= status %></span>
                </div>

                <%-- ✅ Nút "Mark as Packed" nếu đang là Processing --%>
                <% if ("Processing".equalsIgnoreCase(order.getStatus())) { %>
                    <form action="UpdateOrderStatus" method="post" style="margin-top: 10px;">
                        <input type="hidden" name="orderID" value="<%= order.getOrderID() %>">
                        <input type="hidden" name="status" value="Packed">
                        <button type="submit" class="btn btn-packed">Mark as Packed</button>
                    </form>
                <% } %>
